---
title: "Project 4 — Amazon State-Level Monthly Sales Prediction (Regression)"
format:
  html:
    toc: false
---
...
**state × year × month** from 2018–2022, using survey data and order records  
...
- **Engineered features** from order-level data:
  ...
  - `bin1_count`–`bin5_count`: counts of items by price tier
...
predict state-level monthly sales across 2018–2022.
...
- Across six candidate models (linear regression, random forest, XGBoost with both recipes),  
  ...
  **CV RMSE ≈ 0.0927** and a **small standard error (~0.0025)**,  
  beating both random forest and linear regression.
- Adding explicit interaction terms **did not improve** XGBoost’s performance,  
...
👉 [Open PDF](Team%2010%20Regression%20Project%20Report.pdf)